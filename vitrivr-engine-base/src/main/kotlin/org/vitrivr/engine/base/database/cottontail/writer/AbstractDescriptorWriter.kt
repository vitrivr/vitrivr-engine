 ...
 * @version 1.0.0
 */
abstract class AbstractDescriptorWriter<T: Descriptor>(final override val describer: Describer<T>, protected val connection: CottontailConnection): DescriptorWriter<T> {
