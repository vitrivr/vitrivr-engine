 ...
 * @version 1.0.0
 */
class CLIPImageRetriever(field: Schema.Field<ImageContent, FloatVectorDescriptor>, query: FloatVectorDescriptor, context: QueryContext) : ExternalRetriever<ImageContent, FloatVectorDescriptor>(field, query, context) {
