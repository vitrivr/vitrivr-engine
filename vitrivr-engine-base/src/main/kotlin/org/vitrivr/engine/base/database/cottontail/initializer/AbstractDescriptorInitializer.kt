 ...
 * @version 1.0.0
 */
abstract class AbstractDescriptorInitializer<T: Descriptor>(final override val describer: Describer<T>, protected val connection: CottontailConnection): DescriptorInitializer<T> {
