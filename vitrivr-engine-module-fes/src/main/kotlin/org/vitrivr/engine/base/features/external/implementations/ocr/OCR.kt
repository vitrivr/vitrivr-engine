...
class OCR : ExternalFesAnalyser<ImageContent, TextDescriptor>() {
     ...
     * @return [ASRExtractor]
     */
    override fun newExtractor(field: Schema.Field<ImageContent, TextDescriptor>, input: Operator<Retrievable>, context: IndexContext) = OCRExtractor(input, field, this, field.parameters)
