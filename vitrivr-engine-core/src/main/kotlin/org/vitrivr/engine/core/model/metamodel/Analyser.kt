...
interface Analyser<C: Content, D: Descriptor> {
    ...
    /** The [KClass] of the [Content] accepted by this [Analyser].  */
     ...
     */
    fun newExtractor(field: Schema.Field<C,D>, input: Operator<IngestedRetrievable>, persisting: Boolean = true): Extractor<C,D>
     ...
     * @param descriptor An array of [Descriptor] elements to use with the [Retriever]
     *
