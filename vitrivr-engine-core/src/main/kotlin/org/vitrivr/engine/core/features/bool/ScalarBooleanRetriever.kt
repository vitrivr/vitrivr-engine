 ...
 * @version 1.1.0
 */
class ScalarBooleanRetriever<C : ContentElement<*>>(field: Schema.Field<C, ScalarDescriptor<*, *>>, query: BooleanQuery, context: Context) : AbstractRetriever<C, ScalarDescriptor<*, *>>(field, query, context) {
