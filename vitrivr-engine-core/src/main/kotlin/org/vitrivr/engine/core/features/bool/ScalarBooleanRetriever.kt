 ...
 * @version 1.0.0
 */
class ScalarBooleanRetriever<C : ContentElement<*>>(field: Schema.Field<C, ScalarDescriptor<*, *>>, query: BooleanQuery, properties: Map<String, String>) : AbstractRetriever<C, ScalarDescriptor<*, *>>(field, query, properties) {
