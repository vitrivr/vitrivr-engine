...
class  MediaDimensions : Analyser<ContentElement<*>, MediaDimensionsDescriptor> {
    ...
    override fun newExtractor(field: Schema.Field<ContentElement<*>, MediaDimensionsDescriptor>, input: Operator<Retrievable>, context: IndexContext, persisting: Boolean, parameters: Map<String, String>): Extractor<ContentElement<*>, MediaDimensionsDescriptor> {
        TODO("Not yet implemented")
    }
}