...
interface ExtractorFactory<C : ContentElement<*>, D : Descriptor<*>> {
     ...
     */
    fun newExtractor(field: Schema.Field<C, D>, input: Operator<Retrievable>, parameters: Map<String, String>): Extractor<C, D>
     ...
     * @param context The [IndexContext] to use.
     */
    fun newExtractor(name: String, input: Operator<Retrievable>, parameters: Map<String, String>): Extractor<C, D>
}