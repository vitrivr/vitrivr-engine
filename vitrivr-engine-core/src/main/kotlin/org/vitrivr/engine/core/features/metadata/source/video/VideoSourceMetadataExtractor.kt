...
class VideoSourceMetadataExtractor :
    AbstractExtractor<ContentElement<*>, VideoSourceMetadataDescriptor> {
        ...
        constructor(input: Operator<out Retrievable>, analyser: VideoSourceMetadata, field: Schema.Field<ContentElement<*>, VideoSourceMetadataDescriptor>): super(input, analyser, field)
        constructor(input: Operator<out Retrievable>, analyser: VideoSourceMetadata, name: String): super(input, analyser, name)
