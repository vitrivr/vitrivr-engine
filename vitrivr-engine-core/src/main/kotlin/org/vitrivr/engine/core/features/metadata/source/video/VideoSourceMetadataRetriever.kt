 ...
 * @version 1.0.0
 */
class VideoSourceMetadataRetriever(field: Schema.Field<ContentElement<*>, VideoSourceMetadataDescriptor>, query: Query, context: QueryContext) : AbstractRetriever<ContentElement<*>, VideoSourceMetadataDescriptor>(field, query, context)