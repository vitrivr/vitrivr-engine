...
class TemporalMetadata : Analyser<ContentElement<*>, TemporalMetadataDescriptor> {
     ...
     */
    override fun newExtractor(field: Schema.Field<ContentElement<*>, TemporalMetadataDescriptor>, input: Operator<Retrievable>, parameters: Map<String, String>, context: IndexContext) = TemporalMetadataExtractor(input, this, field)
     ...
     * @return [TemporalMetadataExtractor]
     */
    override fun newExtractor(name: String, input: Operator<Retrievable>, parameters: Map<String, String>, context: IndexContext) = TemporalMetadataExtractor(input, this, name)
