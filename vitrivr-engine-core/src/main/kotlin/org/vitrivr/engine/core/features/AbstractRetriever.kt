 ...
 * @version 1.0.1
 */
abstract class AbstractRetriever<C : ContentElement<*>, D : Descriptor<*>>(override val field: Schema.Field<C, D>, val query: Query, val properties: Map<String, String>) : Retriever<C, D> {
