 ...
 * @version 1.1.0
 */
class AverageColorExtractor(input: Operator<Ingested>, field: Schema.Field<ImageContent, FloatVectorDescriptor>?) : AbstractExtractor<ImageContent, FloatVectorDescriptor>(input, field) {
    /**
