...
class MedianFuzzyHist : Analyser<ContentElement<*>, FloatVectorDescriptor> {
    override val contentClasses = setOf(ContentElement::class)
    override val descriptorClass = FloatVectorDescriptor::class
    override fun prototype(field: Schema.Field<*, *>) = FloatVectorDescriptor(UUID.randomUUID(), UUID.randomUUID(), List(15) { Value.Float(0.0f) })
    ...
    override fun newExtractor(field: Schema.Field<ContentElement<*>, FloatVectorDescriptor>?, input: Operator<Ingested>, context: IndexContext): Extractor<ContentElement<*>, FloatVectorDescriptor> {
        TODO("Not yet implemented")
    }
}