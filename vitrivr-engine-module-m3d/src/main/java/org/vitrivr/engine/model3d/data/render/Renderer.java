package org.vitrivr.engine.model3d.data.render;
...
public interface Renderer {
    ...
    /**
     * Changes the positionCamera of the camera. The camera can be freely rotated around the origin [1,0,0] (cartesian coordinates) and it can take any distance from that same origin.
     *
     * @param ex x Position of the Camera
     * @param ey y Position of the Camera
     * @param ez z Position of the Camera
    ...
    /**
     * Changes the positionCamera of the camera. This method should make sure, that camera always points towards the origin [0,0,0]
     *
     * @param ex x Position of the Camera
     * @param ey y Position of the Camera
     * @param ez z Position of the Camera
    ...
    /**
     * Changes the positionCamera of the camera. The camera can be freely rotated around the origin [0,0,0] (cartesian coordinates) and it can take any distance from that same origin (Arc Ball camera).
     *
    ...
    /**
     * Changes the positionCamera of the camera. The camera can be freely rotated around the origin [0,0,0] (cartesian coordinates) and it can take any distance from that same origin.
     *
